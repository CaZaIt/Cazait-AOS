...
internal interface UpdateUserInformationToLocalUseCase {
    suspend operator fun invoke(userInformation: StoredUser)
}
...
internal class UpdateUserInformationToLocalUseCaseImpl @Inject constructor(
    ...
    override suspend fun invoke(userInformation: StoredUser) {
        repository.updateStoredUser(userInformation)
    }
}
